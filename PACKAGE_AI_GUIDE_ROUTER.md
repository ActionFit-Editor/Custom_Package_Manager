...
- `Packages/com.actionfit.merge-content-core/AI_GUIDE.md` - Merge Content Core owns package-neutral content state persistence and idempotent local reward contracts with PlayerPrefs defaults.
