...
- `Packages/com.actionfit.icecream-race.ui/AI_GUIDE.md` - ActionFit Ice Cream Race UI owns the complete original production prefab/image baseline, ReferenceBinding presentation contract, overridable render/animation hooks, and standalone PlayerPrefs demo bootstrap.
...
- `Packages/com.actionfit.lava-rush/AI_GUIDE.md` - ActionFit Lava Rush owns the reusable timed stage-rush state machine, injected-calendar/legacy timer contract, pinned catalog, and durable reward recovery.
