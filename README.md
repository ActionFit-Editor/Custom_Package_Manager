...
{
  "dependencies": {
    "com.actionfit.custompackagemanager": "https://github.com/ActionFit-Editor/Custom_Package_Manager.git#1.1.16"
  }
}
```
...
- 카탈로그 목록: 단일 카탈로그 안에서 Package Manager, 다운로드 받은 패키지, 다운로드 가능한 패키지를 섹션으로 나눠 함께 볼 수 있습니다.
